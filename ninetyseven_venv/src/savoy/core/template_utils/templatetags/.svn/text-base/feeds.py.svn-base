...
Totally stolen from James Bennett's template_utils package (http://code.google.com/p/django-template-utils/).
...
from savoy.core.template_utils.nodes import ContextUpdatingNode
